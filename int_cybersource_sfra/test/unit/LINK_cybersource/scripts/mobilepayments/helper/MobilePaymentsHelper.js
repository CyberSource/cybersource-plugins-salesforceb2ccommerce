...
var MobilePaymentsHelper = proxyquire('../../../../../../../int_cybersource_sfra/cartridges/LINK_cybersource/cartridge/scripts/mobilepayments/helper/MobilePaymentsHelper.js', {
...
order.getPaymentInstruments = function (paymentMethodID) {
...
describe('Mobile payment helper', function () {
    it('validate mobile payment request should return a valid success attribute', function () {
        var result = MobilePaymentsHelper.validateMobilePaymentRequest(order);
