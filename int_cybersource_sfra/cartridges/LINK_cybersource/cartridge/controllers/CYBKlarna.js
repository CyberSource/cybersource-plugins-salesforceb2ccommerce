...
server.post('GetSession', function (req, res, next) {
	...
	var cancelURL = URLUtils.https('Checkout-Begin','provider','cancelfail','signature',encodeURIComponent(signature),'cfk',true).toString();
	var successURL = URLUtils.https('Checkout-Begin','provider','klarna','signature',encodeURIComponent(signature)).toString();
	var failureURL = URLUtils.https('Checkout-Begin','provider','cancelfail','signature',encodeURIComponent(signature),'cfk',true).toString();
...
function updateBillingAddress(basket, email) {
