...
server.post('GetSession', csrfProtection.generateToken, function (req, res, next) {
    ...
    if (currentLocale.country === 'US') {
        ...
        // For CA addresses, set dummy values if state or postal code is missing. Actual values will be updated later in session update.
    ...
    if (purchaseObject.currency === 'N/A' || purchaseObject.grandTotalAmount == 0) {
        ...
        purchasetotals.setGrandTotalAmount(basket.totalNetPrice.value.toString());
