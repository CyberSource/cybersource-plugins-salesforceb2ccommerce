...
function pageContent(pdict){
    ...
    var paypalActive = PaymentMgr.getPaymentMethod(CybersourceConstants.METHOD_PAYPAL).isActive(); 
    var googlePayActive = PaymentMgr.getPaymentMethod(CybersourceConstants.METHOD_GooglePay).isActive();
