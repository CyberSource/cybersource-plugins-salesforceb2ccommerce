...
function CreateFlexKey() {
	    ...
	    var sharedSecret = Site.getCurrent().getCustomPreferenceValue('Flex_Microform_SharedSecret');
	    var keyID = Site.getCurrent().getCustomPreferenceValue('Flex_Microform_KeyID');
        var host = Site.getCurrent().getCustomPreferenceValue('Flex_Microform_HostName');
...
function getTime() {
	...
	var dateLocale = Site.getCurrent().getCustomPreferenceValue('Flex_Microform_DateLocale');
