/**
* Cybersource_ShipTo_Object.js
* This Object is used for the Cybersource ShipTo xsd
*/
function ShipTo_Object() {
	this.title = "";
	this.firstName = "";
	this.middleName = "";
	this.lastName = "";
