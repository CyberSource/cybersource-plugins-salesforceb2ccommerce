...
* **Version:** 26.1.3
* **Compatibility:** <span style="color:red">This version of the Cybersource cartridge is compatible with versions of SFRA Release 7.0.0. </span>
This version can be found on the Master branch of the SFRA repository on June , 2025 <span style="color:red">This version is compatible with Salesforce B2C Commerce 22.7 release. <span>
